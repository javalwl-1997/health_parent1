...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "qT2hutGX4zu6g5VX0iUOQ0QIUYYex2F50TSjzM6n";
    private static final String SECRETKEY = "JLoH0-tYc6zJeio3Y419JozVe8Sh7GuKv858Q3v1";
    private static final String BUCKET = "lwl-health";
    public static final String DOMAIN= "http://qh1fh5eee.hn-bkt.clouddn.com/";
    //测试文件上传
    public static void main(String[] args) {
        uploadFile("C:\\Users\\Administrator\\Desktop\\timg.jpg","光遇.jpg");
