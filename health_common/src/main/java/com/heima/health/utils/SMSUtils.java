...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_203725248";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "传智健康";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4GGbQdWykgpAqYP3GWV1"; //你的AccessKey ID
	private static final String SECRET_KEY="reR4dasUzgivYrNviPaagWMxEiUSU9"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"15139693764","814734");
	}
